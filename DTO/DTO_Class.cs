...
//            {
//                var outputObj = _dbConnection.Query<BUS_Class>($"select CLASS_NAME from CLASS where CLASS_ID ='{ID}'").ToList();
//                if (outputObj.Count == 0) return "";
//                var output = outputObj[0].NameClass;
//                return output;
//            }
//        }
//        public void InsertAClass(BUS_Class _class)
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
...
//            }
//        }
//        public List<BUS_Class> GetAll()
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select * from CLASS order by CLASS_NAME").ToList();
//                return output;
//            }
//        }
//        public List<BUS_Class> GetAllClassGroup()
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select CLASS_GROUP from CLASS GROUP BY CLASS_GROUP").ToList();
//                return output;
//            }
//        }
//        public List<BUS_Class> ReadClassByClassGroup(int class_group)
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select * from CLASS where CLASS_GROUP = '{class_group}'").ToList();
//                return output;
//            }
//        }
//        public List<BUS_Class> ReadClassByID(int class_id)
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select * from CLASS where CLASS_ID = '{class_id}'").ToList();
//                return output;
//            }
//        }
//        public List<BUS_Class> ReadClassByByNameAndClassGroup(string NameClass, int? Class_Group)
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select * from CLASS where CLASS_NAME like N'%{NameClass}%' AND CLASS_GROUP='{ Class_Group}'").ToList();
//                return output;
//            }
//        }
//        public List<BUS_Class> ReadClassByName(string NameClass)
//        {
//            DBConnect _dbContext = new DBConnect();
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                var output = _dbConnection.Query<BUS_Class>($"select * from CLASS where CLASS_NAME like N'%{NameClass}%'").ToList();
//                return output;
//            }
//        }
//        //Xóa lớp
...
//            using (IDbConnection _dbConnection = _dbContext.CreateConnection())
//            {
//                _dbConnection.Query<BUS_Class>($"DELETE from CLASS where CLASS_ID ='{idClass}'");
//            }
//        }
//        /// <summary>
